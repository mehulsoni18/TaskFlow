...
import { Filter, ListChecks, Plus, Clock } from "lucide-react";
...
const PendingPage = () => {
  ...
  return (
    <div className={layoutClasses.container}>
      ...
      >
        <div className="flex items-center justify-center gap-3 text-gray-500 hover:text-purple-600 transition-colors cursor-pointer">
